...
puplishable_key ='pk_test_51M1BFMCRnnetHG6cn96w3cyL667B86tUc3fBx2iWkHhRcmSKPHl02gFsGkU2ioJ43h2XiZJiQJkIe5muNXwA975Q00Ygz1j3y7'
stripe.api_key ='sk_test_51M1BFMCRnnetHG6c3tpLq7FXvDFgrPCXi0qtalrDhNkbphS56D4qPYuHy3lHhqmL49a1iofRc1sCiUA8P3pfC75O0053EcEYUe'
...
def customerLogin():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            return redirect(next or url_for('market'))
